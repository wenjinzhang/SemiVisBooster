...
def exp_usb_cv(label_amount):
    ...
    # algs = ['fullysupervised', 'supervised', 'fixmatch', 'freematch']
    algs = ['flexmatch', 'uda', 'pseudolabel', 'remixmatch', 'mixmatch', 'meanteacher',
             'pimodel', 'vat', 'dash', 'crmatch', 'comatch', 'simmatch', 'adamatch', 'softmatch', 'defixmatch']
    datasets = ['food101']
        ...
        for dataset in datasets:
            for seed in seeds:
                ...
                # NOTE: resize to 32 x 32
                    ...
                    pretrain_name = 'mae_pretrain_vit_base.pth'
                    num_classes = 101
                    num_labels = label_amount[7] * num_classes 
                    lr = 5e-5
                    layer_decay = 0.75
                    weight_decay = 0.03
                    warmup = 10
...
if __name__ == '__main__':
    ...
    label_amount = {'s': [2, 2, 2, 4, 2, 2, 10, 4],
                    'm': [4, 4, 4, 10, 2, 4, 50, 10]}
