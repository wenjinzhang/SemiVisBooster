...
class BasicDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.msn_transform = msn_transform
    ...
    def __getitem__(self, idx):
        ...
        if self.transform is None:
            ...
            if not self.is_ulb:
                ...
                elif 'msn' in self.alg:
                    return {'idx_lb': idx, 'x_lb': img_w, 'x_lb_msn': self.msn_transform(img), 'y_lb': target}
                else:
                ...
                if self.alg == 'fullysupervised' or self.alg == 'supervised':
                    ...
                    return {'idx_ulb': idx, 'x_ulb_w': img_w, 'x_ulb_s': self.strong_transform(img), 'x_ulb_msn': self.msn_transform(img)} 
                else:
