...
tissuemnist_label_text = {
    0: "Tightly packed, elongated cells arranged in clusters with clear tubular outlines, facilitating fluid transport.",
    1: "Rounded, cuboidal cells with a prominent lumen, exhibiting a smooth and organized structure within the tissue.",
    2: "Thin, continuous layer of cells with a fine, mesh-like appearance, contributing to blood filtration.",
    3: "Irregular, flattened cells with elongated nuclei, scattered between kidney tubules, supporting nutrient exchange.",
    4: "Small, round cells with densely stained nuclei, distinct in size and dark appearance compared to other kidney cells.",
    5: "Large, irregular cells with branching extensions forming part of the kidney's filtration barrier.",
    6: "Cells with a brush border of microvilli, giving them a granular appearance, larger and more prominent compared to distal tubule cells.",
    7: "Cuboidal cells, less densely packed than proximal tubule cells, with a smooth, tubular structure."
}
