...
@ALGORITHMS.register('maecomatch')
class MAECoMatch(AlgorithmBase):
    """
    ...
    def train_step(self, x_lb, y_lb, x_ulb_w, x_ulb_s_0, x_ulb_s_1):
        ...
        with self.amp_cm():
            ...
            total_loss = sup_loss + self.lambda_u * unsup_loss + self.lambda_c * contrast_loss + self.lambda_mae * mae_loss
