...
@ALGORITHMS.register('maedefixmatch')
class MAEDeFixMatch(AlgorithmBase):
    ...
    def train_step(self, x_lb, x_lb_s, y_lb, x_ulb_w, x_ulb_s):
        ...
        with self.amp_cm():
            ...
            total_loss = sup_loss + self.lambda_u * (unsup_loss - anti_unsup_loss) + self.lambda_mae * mae_loss 
