...
@ALGORITHMS.register('maevat')
class MAEVAT(AlgorithmBase):
    """
    ...
    def train_step(self, x_lb, y_lb, x_ulb_w):
        ...
        with self.amp_cm():
            outputs = self.model(x_lb, need_mae=True)
            ...
            total_loss = sup_loss + self.lambda_u * unsup_loss * unsup_warmup + self.lambda_ent * loss_entmin+ self.lambda_mae * mae_loss
