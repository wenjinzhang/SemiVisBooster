...
@ALGORITHMS.register('maesimmatch')
class MAESimMatch(AlgorithmBase):
    """
    ...
    def train_step(self, idx_lb, x_lb, y_lb, x_ulb_w, x_ulb_s):
        ...
        with self.amp_cm():
            ...
            total_loss = sup_loss + self.lambda_u * unsup_loss + self.lambda_in * in_loss + self.lambda_mae * mae_loss 
