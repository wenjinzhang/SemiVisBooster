...
@ALGORITHMS.register('maemeanteacher')
class MAEMeanTeacher(AlgorithmBase):
    """
    ...
    def train_step(self, x_lb, y_lb, x_ulb_w, x_ulb_s):
        ...
        with self.amp_cm():
            ...
            self.bn_controller.freeze_bn(self.model)
            outs_x_ulb_s = self.model(x_ulb_s, need_mae=True)
            ...
            mae_loss = outs_x_lb['mae_loss'].sum() / outs_x_lb['mae_mask'].sum() + x_ulb_s['mae_loss'].sum() / x_ulb_s['mae_mask'].sum()
